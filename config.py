...
MAX_LOGIN_ERROR_TIMES=int(os.environ.get("MAX_LOGIN_ERROR_TIMES", 5))
LOGIN_ERROR_LOCK_TIME=int(os.environ.get("LOGIN_ERROR_LOCK_TIME", 5))

DOOR_OPEN_TIME=int(os.environ.get("DOOR_OPEN_TIME", 1764000000))
DOOR_CLOSE_TIME=int(os.environ.get("DOOR_CLOSE_TIME", 1764037800))
...
ERCODE_EXCHANGE_TIME=int(os.environ.get("ERCODE_EXCHANGE_TIME", 1764042300))
